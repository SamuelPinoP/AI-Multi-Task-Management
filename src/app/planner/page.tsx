...
export default async function PlannerPage() {
  ...
  const [activeTasks, todaysEvents, projects] = user
    ? await Promise.all([
        ...
        prisma.event.findMany({
          where: { userId: user.id, deletedAt: null, startTime: { gte: todayStart, lt: tomorrowStart } },
