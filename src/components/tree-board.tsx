  ...
  return (
    <div className="relative flex shrink-0 flex-col items-center">
      <article
        ...
        className={`group relative flex flex-col overflow-visible rounded-[1.35rem] border p-3 shadow-lg ring-1 transition-[border,box-shadow] duration-200 sm:p-4 ${cardTone}`}
      >
        <span
