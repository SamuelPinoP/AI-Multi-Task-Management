  ...
  return (
    <>
      <button
        ...
        className="inline-flex w-full items-center justify-between gap-2 rounded-lg border border-zinc-300 px-3 py-2 text-sm text-zinc-700 transition hover:bg-zinc-100 dark:border-zinc-700 dark:text-zinc-200 dark:hover:bg-zinc-800 sm:w-auto"
      >
      ...
      {isOpen ? (
        <div
          className="fixed inset-0 z-50 flex items-start justify-center bg-zinc-900/45 p-4 pt-20"
          role="dialog"
          aria-modal="true"
        >
          <div
            ref={popupRef}
            className="w-full max-w-2xl overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-xl dark:border-zinc-700 dark:bg-zinc-900"
          >
                  ...
                  <div className="space-y-4">
                    ...
                    <ResultSection
                      ...
                      items={results.tasks.map((item) => ({
                        href:
                          item.status === "DONE" ? "/tasks/board" : "/tasks",
                        title: item.title,
                        type: "Task",
                        project: item.project,
